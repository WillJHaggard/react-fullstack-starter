 ...
 * and split on sections only to improve readability
...
import uxEngRouters from "backend/actions/uxEng";
import softEngRouters from "backend/actions/softEng";
...
forEach(router => app.use("/api/uxEngs/", router), uxEngRouters);
forEach(router => app.use("/api/softEngs/", router), softEngRouters);
