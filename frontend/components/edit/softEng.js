...
export default class softEngEdit extends DeepComponent {
  handleBlur(key) {
    actions.validateEditForm(key).catch(err => null);
  }
    ...
    actions
      ...
      .then(item => {
        alertActions.addItem({
          message: "softEng edited with id: " + item.id,
          category: "success",
        });
      })
      .catch(error => {
        alertActions.addItem({
          message: "Failed to edit softEng: " + error,
          category: "error",
        });
      });
  }
      ...
      <div className="actions">
        <div className="container">
          ...
          <div className="btn-group btn-group-sm pull-right">
            ...
            <ItemLink to="softEng-detail" params={{id: item.id}} className="btn btn-blue" title="Detail">
