...
export default class Body extends Component {
  ...
  render() {
    ...
    return (
      <div>
         <Header component="header" className="navbar header navbar-default headroom" toggleClasses={headerToggleClasses}>
          <div className="container">
            <div className="navbar-header">
              ...
              <Link className="navbar-brand fs" to="about">Test</Link>
            </div>
