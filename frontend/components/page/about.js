      ...
      <DocumentTitle title="React Ultimate :: About">
        <TextHolder>
          <section className="container page home">
            ...
            <h3>Code</h3>
            <p>
              ES2015&mdash;2016 -> frontend, backend, tests, tasks.
            </p>
            ...
            <p>
              Index for <a href="/uxEngs">UX Engineer</a> is URL-bound. State is mirrored
            ...
            <p>
              Index for <a href="/softEngs">Software Engineer</a> is URL-unbound. State is implicit and hidden
            ...
            <p>
              ...
              Recalculates new pagination without API request.
            ...
            <p>
              ...
              about errors. Validations "on blur" and "on submit" are also available.
            ...
            <p>
              ...
              It was practically impossible to do this "right" in backend-driven apps.
            </p>
            ...
            <h3>Text Holders</h3>
            <p>
              The width of text container is auto-regulated to display about 80 character per row.
